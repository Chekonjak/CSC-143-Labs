...
public class MyArrayList<E> implements MyList<E> {
    ...
    public void clear() {
        ...
        items = (E[]) new Object[DEFAULT_CAPACITY]; // TODO: OH MY GOD IT'S GARBAGE COLLECTION!!!
    }
    ...
    public boolean equals(Object o) {
        if (o instanceof MyArrayList) {
            ...
            /*
             * boolean b = true; for (int i = 0; i < size && b; i ++) { if
             * (items[i] == null) { b &= (list.items[i] == null); } else { b &=
             * (items[i].equals(list.items[i])); } } return b;
             */
