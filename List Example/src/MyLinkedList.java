...
public class MyLinkedList<E> implements MyList<E> {
    ...
    public int size() {
        ...
        // }
        // return count;
        // with a size field -> more efficient
        return size;
    }
    ...
    public boolean remove(int index) {
        ...
        // Find the corresponding node (prev points to the node before p)
    ...
    public boolean equals(Object o) {
        if (o instanceof MyLinkedList) {
            ...
            for (Node p = head, q = list.head; p != null; p = p.next, q = q.next) {
                if (p.item == null) { // why not just if (p.item == null &&
                    // q.item != null) { return false;}
                    if (q.item != null) {
                        return false;
                    }
